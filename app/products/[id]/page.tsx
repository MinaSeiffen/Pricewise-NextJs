  ...
  return (
    <div className="product-container">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <p className="text-sm text-black opacity-50">
                  <span className="text-primary-green font-semibold">95%</span> of buyers have recommended this
                </p>
              </div>
            </div>
      ...
      <div className="flex flex-col gap-16">
        ...
        <button className="btn w-fit mx-auto justify-center items-center flex min-w-[200px]">
